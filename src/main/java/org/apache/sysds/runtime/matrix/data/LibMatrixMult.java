...
public class LibMatrixMult 
{
	...
	// note: public for use by codegen for consistency
	public static double dotProduct(double[] a, double[] b, int ai, int bi, final int len) { // TODO:CheckCorrectness
		double val = 0;
	...
	// note: public for use by codegen for consistency
	public static double dotProduct(double[] a, double[] b, int[] aix, int ai, final int bi, final int len) { // TODO:CheckCorrectness
		double val = 0;
		DoubleVector aVec, bVec;
	...
	//note: public for use by codegen for consistency
	public static void vectMultiplyAdd(final double aval, double[] b, double[] c, int bi, int ci, final int len) { // TODO:CheckCorrectness
		int bn = len % speciesLen;
		...
		for(; j < len; j += speciesLen) {
			...
			bVec = DoubleVector.fromArray(SPECIES, b, bi + j); // Create a Vector containing doubles from Array b

			res = avalVec.fma(bVec, res); // Compute res' = aval * b + res
	...
	private static void vectMultiplyAdd2(final double aval1, final double aval2, double[] b, double[] c, int bi1,
		int bi2, int ci, final int len) { // TODO:CheckCorrectness
		int bn = len % speciesLen;
	...
	private static void vectMultiplyAdd3(final double aval1, final double aval2, final double aval3, double[] b,
		double[] c, int bi1, int bi2, int bi3, int ci, final int len) { // TODO:CheckCorrectness
		int bn = len % speciesLen;
	...
	private static void vectMultiplyAdd4(final double aval1, final double aval2, final double aval3, final double aval4,
		double[] b, double[] c, int bi1, int bi2, int bi3, int bi4, int ci, final int len) { // TODO:CheckCorrectness
		int bn = len % speciesLen;
		...
		for(; j < len; j += speciesLen) {
			...
			res = aval3Vec.fma(b3Vec, res); // compute res' = aval3 * b3 + res
			res = aval4Vec.fma(b4Vec, res); // compute res' = aval4 * b4 + res => same principle as above
			res.intoArray(c, ci + j);
		}
	}
	...
	// note: public for use by codegen for consistency
	public static void vectMultiplyAdd(final double aval, double[] b, double[] c, int[] bix, int bi, int ci, int len) { // TODO:CheckCorrectness
		DoubleVector avalVec = DoubleVector.broadcast(SPECIES, aval);
