...
public class LibMatrixBincell2 {
	...
	private static long safeBinaryMVDenseColVector(MatrixBlock m1, MatrixBlock m2, MatrixBlock ret, BinaryOperator op,
		...
		if(b == null) {
			...
			int max = SPECIES.loopBound(clen);
